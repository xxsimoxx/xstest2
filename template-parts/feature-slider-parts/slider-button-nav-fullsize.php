...
if ( 0 !== $category_id && $custom_posts ) {
	?>
	<div id="canuck-cp-feature-fullsize-id" class="splide canuck-cp-feature-fullsize" data-splide=<?php echo '{"type":"' . esc_attr( $canuckcp_effect ) . '","arrows":1,"rewind":1,"interval":' . intval( $canuckcp_pause ) . ',"speed":' . intval( $canuckcp_trans ) . ',"autoplay":' . esc_attr( $canuckcp_auto ) . '}'; ?>>
