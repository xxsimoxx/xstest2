	...
	<div class="portfolio-four-column-wrap">
		...
		foreach ( $custom_posts as $post ) { // phpcs:ignore
			...
			if ( has_post_thumbnail() ) {
				if ( 0 === $canuckcp_feature_pic_count || is_int( $canuckcp_feature_pic_count / 4 ) ) {
					?>
					<div class="portfolio-four-column col-1">
					<?php
				} elseif ( is_int( ( $canuckcp_feature_pic_count + 1 ) / 4 ) ) {
					?>
					<div class="portfolio-four-column col-4">
					<?php
				} elseif ( ( 0 === $canuckcp_feature_pic_count - 1 ) || is_int( ( $canuckcp_feature_pic_count - 1 ) / 4 ) ) {
					?>
