...
$canuckcp_layout_option       = get_theme_mod( 'canuckcp_category_layout', 'right_sidebar' );
...
$canuckcp_exclude_page_title  = get_theme_mod( 'canuckcp_category_title' ) ? true : true;
